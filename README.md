...
[webots](https://cyberbotics.com/)|Webots is an open source robot simulator that provides a complete development environment to model, program and simulate robots.|Simulator|R2019b-rev1||All platforms|C++| Apache 2.0 license|[GitHub](https://github.com/cyberbotics/webots)|
